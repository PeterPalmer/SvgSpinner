...
(function (Shapes) {
    var SpinnerModel = (function () {
        ...
        SpinnerModel.prototype.LoadSvgPath = function (pathStr, fillColor, strokeColor) {
            ...
            this.paths.push(new Shapes.Path(fillColor, strokeColor));
            ...
            for (var curveIdx = 0; curveIdx < curves.length; curveIdx++) {
                ...
                if (command == "M") {
                    currentPath.shapes.push(new Shapes.MovePenTo(curves[curveIdx][1], curves[curveIdx][2], currentZ));
                } else if (command = "C") {
                    currentPath.shapes.push(new Shapes.BezierCurve(currentX, currentY, currentZ, curves[curveIdx][5], curves[curveIdx][6], currentZ, curves[curveIdx][1], curves[curveIdx][2], currentZ, curves[curveIdx][3], curves[curveIdx][4], currentZ));
    ...
    Shapes.SpinnerModel = SpinnerModel;
})(Shapes || (Shapes = {}));
